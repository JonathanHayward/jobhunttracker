  ...
  var Calendar = React.createClass(
    ...
    render_basic_entry: function(entry)
      ...
      result.push(<li><input type="checkbox" name="advanced"
        ...
        Recurring event</li>);
      return <div><p><strong>Add a new calendar entry:</strong></p><ul>{result}</ul></div>;
      },
          ...
          if (activities_today.length)
            ...
            if (activities_today.length)
              ...
              for(var index = 0; index < activities_today.length;
                ...
                if (activity.all_day)
                  {
                  rendered_activities.push(<li className="all-day"
                  ...
                  {
                  rendered_activities.push(<li className="minutes"
                    dangerouslySetInnerHTML={{__html:
                    format_time(hour_options[activity.hours][1],
                  ...
                  {
                  rendered_activities.push(<li className="hours"
                    dangerouslySetInnerHTML={{__html:
                    format_time(hour_options[activity.hours][1]) +
  ...
  */
  var YouPick = React.createClass(
    ...
    render: function()
      ...
      return (
        <div id="YouPick">
          <h2><em>Guess what's coming next?</em></h2>
